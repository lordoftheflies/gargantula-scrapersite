...
APPLICATION_NAME = 'scrapersite'
SOLUTION_NAME = 'gargantula'
FINAL_NAME = SOLUTION_NAME + '-' + APPLICATION_NAME
...
# ========================================
main_ns = {}
ver_path = convert_path(APPLICATION_NAME + '/version.py')
...
setup(
    ...
    url='https://github.com/lordoftheflies/' + SOLUTION_NAME + '/',
    classifiers=[
