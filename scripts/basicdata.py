...
def import_data():
    ...
    auth_user_1 = User()
    auth_user_1.password = 'pbkdf2_sha256$36000$kSVCfAmb4HuL$nysvnm7r27pCCpHjJPfpdlXWb3N0JtU6FyVSqhXBjNM='
    auth_user_1.last_login = dateutil.parser.parse("2017-08-24T11:38:59.615547+00:00")
    ...
    auth_user_1.date_joined = dateutil.parser.parse("2017-08-21T23:34:34.062476+00:00")
