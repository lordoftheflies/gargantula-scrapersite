...
def import_data():
    ...
    botapp_projectstepmodel_13.html_query = '#flight-FR\7e 8415\7e \20 \7e \7e BUD\7e 09\2f 09\2f 2017\20 20\3a 20\7e CRL\7e 09\2f 09\2f 2017\20 22\3a 25\7e > div > div.flight-header__min-price.hide-mobile'
    ...
    botapp_projectstepmodel_14.html_query = '#flight-FR\7e 8416\7e \20 \7e \7e CRL\7e 10\2f 14\2f 2017\20 17\3a 55\7e BUD\7e 10\2f 14\2f 2017\20 19\3a 55\7e > div > div.flight-header__min-price.hide-mobile > flights-table-price > div > div.core-btn-primary'
    ...
    botapp_projectstepmodel_17.display_name = 'Csomag hozzáadása'
    botapp_projectstepmodel_17.order_index = 17
    botapp_projectstepmodel_17.action_type = 'clickAndWait'
    botapp_projectstepmodel_17.value = '1.0'
    botapp_projectstepmodel_17.html_query = 'body > div.FR > main > div.body-section > extras-panels > section > article > leaderboard > div > extras-card:nth-child(3) > ng-include > div > div.action > button.core-btn-primary.add'
    ...
    botapp_projectstepmodel_18.display_name = 'Csomag hozzáadása felugró'
    botapp_projectstepmodel_18.order_index = 18
    botapp_projectstepmodel_18.action_type = 'clickAndWait'
    botapp_projectstepmodel_18.value = '1.0'
    botapp_projectstepmodel_18.html_query = '#dialog-body-slot > dialog-body > bag-selection > div > div.transfer-side-content > div.equipment-wrapper > div.equipment-passengers > bags-per-person > div > div.bags-info > div:nth-child(1) > single-bag-in-row > div:nth-child(1) > bags-selector-icon:nth-child(1) > div'
    botapp_projectstepmodel_18.variable = False
    ...
    botapp_projectstepmodel_16.display_name = 'Összeg mentése'
    botapp_projectstepmodel_16.order_index = 16
    botapp_projectstepmodel_16.action_type = 'storeSelectedValue'
    botapp_projectstepmodel_16.value = 'lowest_price'
    botapp_projectstepmodel_16.html_query = '#booking-selection > article > div.cart.cart-empty > section > div.trips-basket.trips-total > trips-breakdown > div.breakdown > div > div.price-number.notranslate.short-price'
    ...
    botapp_projectstepmodel_19.variable = False
    ...
    botapp_projectstepmodel_20.variable = False
    ...
    botapp_projectstepmodel_21.variable = False
    ...
    botapp_projectstepmodel_22.variable = False
