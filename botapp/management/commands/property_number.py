...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        property = botapp.models.NumberPropertyModel.objects.create(
            name=property_name,
            display_name=display_name,
            default_value=property_value
        )

        self.stdout.write(self.style.SUCCESS('Successfully created numeric property %s[pk=%s]' % (property.display_name, property.pk)))
